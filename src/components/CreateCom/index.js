...
export { default as XhDiscount } from './XhDiscount'
export { default as XhContractAmount } from './XhContractAmount'
...
export { default as XhChannelCategory } from './XhChannelCategory'
export { default as XhDetail } from './XhDetail'
export { default as XhDictionary } from './XhDictionary'
export { default as XhCause } from './XhCause'
export { default as XhTag } from './XhTag'
