...
// import { memberCallQqueryListAPI } from "@/api/businessIntelligence/callCenter"
import { crmCallIndex, crmCallDownload } from '@/api/businessIntelligence/callCenter'
...
export default {
  ...
  mounted() {
    ...
    window.onresize = function() {
      ...
      self.tableHeight = offsetHei - 205
    }
  },
  methods: {
