<template>
  <el-popover
    ...
    <!-- <span
      v-if="manage.viewSetting"
      slot="reference"
      type="primary"
      style="margin-right:15px;color:#2362FB;"
      @click="showList('filter')">筛选项配置</span> -->
    <span
      slot="reference"
      class="hover-color"
      style="color:#2362FB;"
      type="primary"
      @click="showList('list')">编辑顺序</span>
  </el-popover>
</template>
